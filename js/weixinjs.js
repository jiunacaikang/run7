	...
	wx.ready(function () {
		...
		window.ShareUpData = function (){
			...
			success: function () { 
				...
				_hmt.push(['_trackEvent', '同程旅游', '分享', '发送好友成功']);
			...
			success: function () { 
				...
				_hmt.push(['_trackEvent', '同程旅游', '分享', '分享成功']);
...
var WEBURL = 'http://ty.eshyp.com/run7YunOS/'	
window.wxData = {
        "imgUrl" : WEBURL + 'images/share_bg.png',
        "link" : 'http://ty.eshyp.com/run7YunOS',
        "title" : document.title,
        "desc" : '世俱杯决赛最新动态：三分钟内要让C罗到达现场',
		succ : function (){}
};
